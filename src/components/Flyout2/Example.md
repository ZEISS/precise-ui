...
```jsx
const { Flyout2 } = require('precise-ui');

<Flyout2 content={'Flyout content'}>
  Wrapped element
</Flyout2>
```
...
```jsx
const { Tag, Flyout2 } = require('precise-ui');

<div style={{width: '100%', display: 'flex', justifyContent: 'space-between'}}>
  <Flyout2 open position={'right'} content="Right">
    <Tag type="primary">Element</Tag>
  </Flyout2>

  <Flyout2 open position={'top'} content="Top">
    <Tag type="info">Element</Tag>
  </Flyout2>

  <Flyout2 open position={'bottom'} content="Bottom">
    <Tag type="secondary">Element</Tag>
  </Flyout2>

  <Flyout2 open position={'left'} content="Left">
...
```jsx
const { Flyout2, Button } = require('precise-ui');
...
```jsx
const { Flyout2, Button, InteractiveList } = require('precise-ui');
...
```jsx
const { Flyout2, Button, Avatar, InteractiveList } = require('precise-ui');
...
```jsx
const { Flyout2, RadioButton, StackPanel, StackItem } = require('precise-ui');
