...
export const light: PreciseFullTheme = {
  ...
  toggleBackground: colors.ui4,
  toggleCheckedBackground: colors.ui4,
  ...
  actionLinkHoverBackground: colors.skyBlue,
  actionLinkDisabledText: colors.white,
  inputInfo: colors.text2,
  fontFamily: 'inherit',
  ...
  indicatorKnobActiveBackground: colors.ui0,
